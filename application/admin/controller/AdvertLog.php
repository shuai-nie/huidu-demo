...
class AdvertLog extends Base
{
    ...
    public function index()
    {
        ...
        if(request()->isPost()){
            ...
            $count = Db::query("select count(*) as cou from ($sql1) as t where show_status = 3 " . $where);
            $list = Db::query("select * from ($sql1) as t where show_status = 3  " . $where . " limit $offset, $limit");
