...
//        $detail = explode("<div class=\"cif-article", $detail);
    ...
    public function kchuhai_desc($url)
    {
        ...
        $reg4 = "/<div class=\"kch-zhezhaoMark pointer w-100 flex([\S\s]+?)<\/div>/";
        $reg5 = "/<div class=\"w-100 flex justify-start px-3 py-2([\S\s]+?)<\/div>/";
        $reg6 = "<div class=\"flex justify-start flex-wrap";
